# DATA_SCHEMA.md - Variable & Data Structures (v3.14)
...
- **Auto-Analysis Trigger Policy**: 번호가 6개 완성되는 모든 액션(직접 클릭, 자동, 반자동)에 대해 즉시 분석 엔진(`runDetailedAnalysis`)을 가동하여 결과 섹션을 활성화함.
