...
const height = 200; // 상하 길이를 충분히 늘려 가독성 확보
const padding = 50;
const chartWidth = width - padding * 2;
const chartHeight = height - 70; // 데이터 곡선의 진폭을 키움
const baselineY = height - 40; // 하단 라벨과의 여유 공간 확보
...
svg.appendChild(xAxis);    const hatchId = `hatch-optimal-${elementId}`;
